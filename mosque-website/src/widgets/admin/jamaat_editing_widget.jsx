...
export const JamaatEditingWidget = ({saveEntry, editingIndex, setEditingIndex, editForm, setEditForm, formErrors, setFormErrors}) => {
  const pageStrings = Strings["jamaat_editing"];
  return (
    <form
      onSubmit={(e) => {
        e.preventDefault();
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-2xl w-full max-h-screen overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-2">{pageStrings.jamaat_name}</label>
              <input
                type="text"
                value={editForm.name}
